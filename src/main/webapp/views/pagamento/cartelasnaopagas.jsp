                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div
                            ...
                            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">LISTA DE CARTELAS NÃO
                                PAGAS</h1>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text alert alert-danger">Todas cartelas
                                        não pagas pelo o endereço selecionado estão listadas abaixo.</p>
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4 font-weight-bold">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Informo o limit de registro que você deseja vizualizar</h6>
