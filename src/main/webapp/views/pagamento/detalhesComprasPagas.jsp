                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h1 class="text-center font-weight-bold">Detalhes da
                                            compras</h1>
                                        <p class="text-center"><a href="controller?operacao=ExibirCartelasPagas" class="btn btn-outline-primary font-weight-bold"><i class="fas fa-reply-all"></i> Voltar</a></p>	
