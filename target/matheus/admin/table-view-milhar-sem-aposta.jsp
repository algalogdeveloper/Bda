<div class="card">
    <div class="card-header">Compras com quantidade Irregulares</div>
    <div class="card-body">
        ...
        <table class="table table-borderless text-center">
            <caption>
                Total de apostas:
                <c:out value="${tqtdTalaocorrigido}" />
            </caption>
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
                <c:choose>
                    <c:when test="${not empty compras3}">
                        <c:forEach items="${compras3}" var="c">
                            <tr>
